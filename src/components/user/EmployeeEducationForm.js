  ...
  return (
    <div>
      ...
      >
        ...
        >
          <Input placeholder="Diplôme le plus élevé" />
        </Form.Item>

        <Form.Item
          {...restField}
          name={[name, "fieldOfStudy"]}
          rules={[{ required: true, message: "Niveau d'études Manquant" }]}
        >
          <Input placeholder="Niveau d’étude le plus élevé" />
        </Form.Item>
        ...
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: "Compétence manquante"
            }
          ]}
        >
          <Input placeholder="Compétence(s)" />
        </Form.Item>
        ...
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: "Qualification manquante"
            }
          ]}
        >
