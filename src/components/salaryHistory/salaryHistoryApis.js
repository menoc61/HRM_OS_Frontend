...
export const addSalaryHistory = async (values) => {
  try {
    ...
    toast.error(
      "Erreur lors de l'ajout à nouveau de l'historique des salaires"
    );
...
export const updateSalaryHistory = async (id, values) => {
  try {
    ...
    toast.error(
      "Erreur lors de la mise à jour à nouveau de l'historique des salaires"
    );
    console.log(error.message);
...
export const deleteSalaryHistory = async (id) => {
  try {
    ...
    toast.error(
      "Erreur lors de la suppression à nouveau de l'historique des salaires"
    );
    console.log(error.message);
    return {
      message: "error"
